...
class HttpClientLandNotLegal(object):
    def __init__(self, host=None, port=None, protocol=None, path=None, method=None,
        ...
        self.path = path if path else CONFIG["land_not_legal"]["path"]
        self.method = method if method else CONFIG["land_not_legal"]["method"]
        self.username_key = username_key if username_key else CONFIG["land_not_legal"]["username_key"]
        self.username = username if username else CONFIG["land_not_legal"]["username"]
        self.password_key = password_key if password_key else CONFIG["land_not_legal"]["password_key"]
        self.password = password if password else CONFIG["land_not_legal"]["password"]
